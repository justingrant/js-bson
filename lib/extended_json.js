...
const bsonTypeMappings = {
  Binary: o => new Binary(o.value, o.subtype),
  Code: o => new Code(o.code, o.scope),
  DBRef: o => new DBRef(o.collection, o.oid, o.db, o.fields),
  Decimal128: o => new Decimal128(o.bytes),
  Double: o => new Double(o.value),
  Int32: o => new Int32(o.value),
  Long: o => Long.fromValue(o),
  MaxKey: o => new MaxKey(),
  Minkey: o => new MinKey(),
...
function serializeDocument(doc, options) {
  ...
  if (typeof bsontype === 'undefined') {
    ...
    if (typeof _doc.toExtendedJSON !== 'function') {
      ...
      const mapper = bsonTypeMappings[bsontype];
      if (!mapper) {
    ...
    if (bsontype === 'Code' && _doc.scope) {
      _doc = new Code(_doc.code, serializeDocument(_doc.scope, options));
    } else if (bsontype === 'DBRef' && _doc.oid) {
      _doc = new DBRef(_doc.collection, serializeDocument(_doc.oid, options), _doc.db, _doc.fields);
    }
